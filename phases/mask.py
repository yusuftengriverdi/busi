...
if __name__ == '__main__':
    ...
    labels, kmeans_roi_bbox = kmeans_roi(image)
    ...
    axs[3].imshow(cv2.cvtColor(superpixel_roi_image, cv2.COLOR_BGR2RGB))
    axs[3].imshow(segments)

    axs[3].set_title('Superpixel ROI')
